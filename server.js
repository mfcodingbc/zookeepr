...
function filterByQuery(query, animalsArray) {
    ...
    // animalsArray is saved as filteredResults
...
app.post('/api/animals', (req, res) => {
    // req.body is where the incoming content from client-side will be located
...
// wildcard route: any route not defined will redirect user to this route instead
app.get('*', (req, res) => {
    res.sendFile(path.join(__dirname, './public/index.html'));
});
